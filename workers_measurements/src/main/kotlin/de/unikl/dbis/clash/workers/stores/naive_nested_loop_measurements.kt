...
/**
 * Measure the naive nested loop store.
 *
...
fun main(args: Array<String>) {
    ...
    repeat(10) {
        val tm = NaiveNestedLoopMeasurement(1000, 50000, 1, 1, 1, 1) // 16233.7
...
class NaiveNestedLoopMeasurement(
    ...
    fun run(): Long {
        ...
        val store = NaiveNestedLoopStore<EmptyReceiver>(ClashConfig())
